#!/usr/bin/env python3
# Based on https://github.com/pimoroni/enviroplus-python/blob/master/examples/all-in-one-no-pm.py
...
logging.info("""all.py - Displays readings from all of Enviro plus' sensors
